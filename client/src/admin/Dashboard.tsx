  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <div className="container mx-auto px-4 py-10 max-w-4xl">
        ...
        {/* Visitor Log entry */}
        <button
          onClick={() => setLocation("/admin/visitor-log")}
          className="group mt-3 w-full flex items-center justify-between rounded-2xl border border-zinc-800 bg-zinc-900 px-5 py-4 transition-all duration-200 hover:bg-zinc-800/80 hover:border-zinc-700"
        >
          <span className="flex items-center gap-3">
            <span className="inline-flex items-center justify-center w-9 h-9 rounded-xl bg-emerald-600/15 text-emerald-400">
              <svg className="w-4.5 h-4.5" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M3 3v18h18M7 15l3-4 3 3 4-6" />
              </svg>
            </span>
            <span className="text-left">
              <span className="block text-sm font-semibold text-white">Statistik Pengunjung</span>
              <span className="block text-xs text-zinc-500">Kunjungan, halaman populer, lokasi &amp; perangkat</span>
            </span>
          </span>
          <svg className="w-4 h-4 text-zinc-500 group-hover:text-zinc-300 group-hover:translate-x-0.5 transition-all" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
